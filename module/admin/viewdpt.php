				...
				<div class="col-lg-4">
					<div class="blog_right_sidebar">
						<aside class="single_sidebar_widget post_category_widget">
                            <center>	
								<h4 class="widget_title"><font  color="black" face="century gothic">PEROLEHAN SUARA</font></h4>
								<table>
									<tr>
										<td>
											<div class="card">
												<a href="viewrw.php" class="genric-btn warning radius"><h2><font  color="white" face="century gothic">&nbsp;&nbsp;&nbsp; SUARA RW &nbsp;&nbsp;&nbsp;</font></h2></a>
											</div>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td>
											<div class="card">
								    			<a  href="viewrt.php" class="genric-btn warning sradius"><h2><font color="white" face="century gothic">&nbsp;&nbsp;&nbsp; SUARA RT &nbsp;&nbsp;&nbsp;</font></h2></a>
											</div>
										</td>
									</tr>
								</table>
